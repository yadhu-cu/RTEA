...
<html lang="en">
  <head>
    ...
    <!-- endinject -->
    <!-- Layout styles -->
    <link rel="stylesheet" href="../Distribution/css/style.css "> <!-- End layout styles -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <!-- <div class="page-header">
              <h3 class="page-title" style="font-color: #1bdbe0;"> PRODUCT REQUEST </h3>
              ...
              <div class="col-md-4 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" action="../shpreq.php" >
